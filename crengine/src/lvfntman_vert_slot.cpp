...
// =============================================================================
// Vertical-rl glyph rotation helpers (Phase D A2: extracted from lvfntman.cpp).
//
// Used by DrawTextString for glyphs that need explicit 90° CW rotation when
// the font lacks a +vert OpenType substitution.  Forward-declared in
// lvfntman.cpp at the call sites.
// =============================================================================

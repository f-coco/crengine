...
//
// lvtextfm.cpp, lvtextfm_layout_h.cpp and lvtextfm_vert.cpp form one
// translation unit (the latter two are #include'd at the bottom of
// lvtextfm.cpp).  This header concentrates fork-only forward declarations
// and small ruby-detection helpers in one place so lvtextfm.cpp stays
// closer to upstream.  It must be included after lvtinydom.h / fb2def.h /
...
// Horizontal layout free functions (defined in lvtextfm_layout_h.cpp,
...
// Punctuation helpers (defined in lvtextfm_layout_h.cpp; used from
